...
@section('css')
    <style type="text/css">
        .innerpage-titlebar {
            padding: 80px 0 80px;
            position: relative;
            background: url({{asset('upload/applicationpagesetting/'.$page->background_image)}});
 ...
 {{-- {{dd($req->request->get('first_name'))}} --}}
    ...
    @isset($page)
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="about-col text-center">
                                <h1 id="getstarted" class="separator-center" style="font-size: 18px;">{{$page->form_title}}</h1>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <small>
                                                            <p class="description" style="font-size: 11px;line-height:11px;color:black; margin-top:-20px;">{{$page->form_state_your_case_below_text}}</p>
                                                        </small>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-xs-12 col-sm-12 col-lg-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-xs-12 col-sm-12 col-lg-4">
                                                    ...
                                                    <small>
                                                        <p class="description" style="font-size: 11px;line-height:11px;color:black;margin-top:-20px;">{{$page->form_phone_below_text}}</p>
                                                    </small>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-xs-12 col-sm-12 col-lg-4">
                                                    ...
                                                    <small>
                                                        <p style="font-size: 11px;line-height:11px;color:black;margin-top:-20px;">
                                                            {{$page->form_how_contact_you_below_text}}
                                                        </p>
                                                    </small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 text-right">
                                                    <p style="text-align: left; font-size:20px;">{{$page->form_footer_below_text}}</p>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 text-right">
                                                    <button class="btn btn-default simple-btn save-application" type="button">{{$page->form_button_text}}</button>
                                                </div>
                                            </div>
                                        </div>
        ...
        @else
            <section class="innerpage-titlebar" style="--my-innerpage-titlebar-color:{{$page->background_forecolor}};">
                <div class="container">
                    <h3 class="fix-barcum-head">Page is not available Now</h3>
                </div>
            </section>
