    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('faqcontent/list')}}">Datatable </a></li>
              <li class="breadcrumb-item"><a href="{{url('faqcontent/create')}}">Create New </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify FAQ Content</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('faqcontent/create')}}"> 
                        Create 
                        <i class="fas fa-plus"></i>
                    </a>
                </li>
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('faqcontent/list')}}"> 
                        Data 
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('faqcontent/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select2" style="width: 100%;"  id="category_id" name="category_id">
                                        ...
                                        @if(isset($dataRow->category_id))
                                            @if($dataRow->category_id==$FAQCategory->id)
                                                selected="selected" 
                                            @endif
                                        @endif 
                                         value="{{$FAQCategory->id}}">{{$FAQCategory->name}}</option>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        class="form-control" placeholder="Enter Title" id="content_title" name="content_title">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" rows="3"  placeholder="Enter Detail" id="content_detail" name="content_detail"><?php 
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('faqcontent/edit/'.$dataRow->id)}}">
