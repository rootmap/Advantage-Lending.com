                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="compose-textarea" class="form-control" rows="3"  placeholder="Enter Short Detail" id="short_detail" name="short_detail"></textarea>
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="composes-textarea" class="form-control" rows="3"  placeholder="Enter Long Detail" id="long_detail" name="long_detail"></textarea>
                      </div>
                    </div>
                </div>
                <div class="row">
