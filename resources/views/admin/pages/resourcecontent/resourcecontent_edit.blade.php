...
@section("title","Edit Resource Content")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('resourcecontent/list')}}">Datatable </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Resource Content</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                ...
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('resourcecontent/list')}}"> 
                        Data 
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('resourcecontent/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                            ...
                            <div class="col-md-6">
                                @if(isset($dataRow->image))
                                    @if(!empty($dataRow->image))
                                        <img class="img-thumbnail" src="{{url('upload/resourcecontent/'.$dataRow->image)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('resourcecontent/edit/'.$dataRow->id)}}">
