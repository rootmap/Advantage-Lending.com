      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Contact Us</h3>
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('contactus/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
            ...
            <div class="card-body">
                            ...
                            <div class="col-md-6">
                                @if(isset($dataRow->background_image))
                                    @if(!empty($dataRow->background_image))
                                        <img class="img-thumbnail" src="{{url('upload/contactus/'.$dataRow->background_image)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" rows="3"  placeholder="Enter Form Heading" id="form_heading" name="form_heading"><?php 
                                if(isset($dataRow->form_heading)){
                                    
                                    echo $dataRow->form_heading;
                ...
                <div class="row">
                    <div class="col-sm-12">
                      <!-- text input -->
                      <div class="form-group">
                        <label for="form_bottom_content">Form Bottom Content</label>
                        <textarea class="form-control textarea" rows="3"  placeholder="Enter Form Bottom Content" id="form_bottom_content" name="form_bottom_content"><?php 
                                if(isset($dataRow->form_bottom_content)){
                                    
                                    echo $dataRow->form_bottom_content;
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('contactus/edit/'.$dataRow->id)}}">
