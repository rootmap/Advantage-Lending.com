                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3"  placeholder="Enter Form Heading" id="form_heading" name="form_heading"></textarea>
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3"  placeholder="Enter Form Bottom Content" id="form_bottom_content" name="form_bottom_content"></textarea>
                      </div>
                    </div>
                </div>
