                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Contact  About Name</th>
                            <th class="text-center">State  Case Name</th>
                            <th class="text-center">Phone</th>
                            <th class="text-center">Email</th>
                            <th class="text-center">Attorney’s Name</th>
                    ...
                    <tbody>
                        @if(count($dataRow))
                            @foreach($dataRow as $row)  
                                <tr>
                                    <td class="text-center">{{$row->id}}</td><td class="text-center">{{$row->first_name}}</td><td class="text-center">{{$row->last_name}}</td><td class="text-center">{{$row->contact__about_name}}</td><td class="text-center">{{$row->state__case_name}}</td><td class="text-center">{{$row->phone}}</td><td class="text-center">{{$row->email}}</td><td class="text-center">{{$row->attorney’s_name}}</td><td class="text-center">{{$row->request_status}}</td>
