...
@section("title","Create New Broker Form")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('brokerform/list')}}">Broker Form Data</a></li>
              <li class="breadcrumb-item active">Create New Broker Form</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New Broker Form</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                <li class="page-item"><a class="page-link bg-primary" href="{{url('brokerform/list')}}"> Data <i class="fas fa-table"></i></a></li>
                <li class="page-item">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('brokerform')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('brokerform/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
