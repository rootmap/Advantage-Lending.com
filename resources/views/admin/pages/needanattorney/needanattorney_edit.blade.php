...
@section("title","Edit Need An Attorney")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('needanattorney/list')}}">Datatable </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Need An Attorney</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                ...
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('needanattorney/list')}}"> 
                        Data 
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('needanattorney/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
        ...
        <div class="row">
            <div class="col-sm-12">
              ...
              <label>Choose Request Status</label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio"  
                                <?php 
                                if($dataRow->request_status=="Agreed"){
                                    ?>
                                    checked="checked" 
                                    <?php 
                                }
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio"  
                                <?php 
                                if($dataRow->request_status=="Rejected"){
                                    ?>
                                    checked="checked" 
                                    <?php 
                                }
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio"  
                                <?php 
                                if($dataRow->request_status=="Refer To Another"){
                                    ?>
                                    checked="checked" 
                                    <?php 
                                }
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('needanattorney/edit/'.$dataRow->id)}}">
