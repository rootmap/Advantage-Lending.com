...
@section("title","Create New Need Atterney Page Setting")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Create New Need Atterney Page Setting</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New Need Atterney Page Setting</h3>            
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('needatterneypagesetting')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3"  placeholder="Enter Page Bottom Description" id="page_bottom_description" name="page_bottom_description"></textarea>
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Page Bottom Button Text" id="page_bottom_button_text" name="page_bottom_button_text">
                      </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('needatterneypagesetting/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
