...
@section("title","Edit About Meet Our Team Member")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('aboutmeetourteammember/list')}}">Datatable </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify About Meet Our Team Member</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                ...
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('aboutmeetourteammember/list')}}"> 
                        Data 
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('aboutmeetourteammember/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                      ...
                                      <input type="hidden" value="{{$dataRow->team_image}}" name="ex_team_image" />
                                      <label class="custom-file-label" for="customFile">Choose Team Image</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if(isset($dataRow->team_image))
                                    @if(!empty($dataRow->team_image))
                                        <img class="img-thumbnail" src="{{url('upload/aboutmeetourteammember/'.$dataRow->team_image)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
        ...
        <option value="">Please select</option>
            <option 
                    <?php 
                    if($dataRow->image_with_border=="Disable"){
                        ?>
                        selected="selected" 
                        <?php 
                    }
            ...
            <option 
                    <?php 
                    if($dataRow->image_with_border=="Enable"){
                        ?>
                        selected="selected" 
                        <?php 
                    }
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('aboutmeetourteammember/edit/'.$dataRow->id)}}">
