...
@section("title","Edit Types Of Fund Cases We Fund Type")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Update Types Of Fund Cases We Fund Type</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Types Of Fund Cases We Fund Type</h3>
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('typesoffundcaseswefundtype/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('typesoffundcaseswefundtype/edit/'.$dataRow->id)}}">
