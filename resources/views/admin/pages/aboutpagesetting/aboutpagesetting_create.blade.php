...
@section("title","Create New About Page Setting")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Create New About Page Setting</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New About Page Setting</h3>            
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('aboutpagesetting')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Page Heading Title" id="page_heading_title" name="page_heading_title">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3"  placeholder="Enter Page Sub Heading" id="page_sub_heading" name="page_sub_heading"></textarea>
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3"  placeholder="Enter Page Short Content" id="page_short_content" name="page_short_content"></textarea>
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3"  placeholder="Enter Page Options" id="page_options" name="page_options"></textarea>
                      </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('aboutpagesetting/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
