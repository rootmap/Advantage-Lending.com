...
@section("title","Edit About Media Setting")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Update About Media Setting</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify About Media Setting</h3>
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('aboutmediasetting/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        class="form-control" placeholder="Enter Button Text" id="button_url" name="button_url">
                      </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('aboutmediasetting/edit/'.$dataRow->id)}}">
