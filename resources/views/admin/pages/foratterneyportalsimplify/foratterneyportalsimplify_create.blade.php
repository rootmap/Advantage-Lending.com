...
@section("title","Create New For Atterney Portal simplify")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Create New For Atterney Portal simplify</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New For Atterney Portal simplify</h3>            
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('foratterneyportalsimplify')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('foratterneyportalsimplify/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
