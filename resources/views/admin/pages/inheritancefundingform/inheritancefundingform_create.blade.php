...
@section("title","Create New Inheritance Funding Form")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('inheritancefundingform/list')}}">Inheritance Funding Form Data</a></li>
              <li class="breadcrumb-item active">Create New Inheritance Funding Form</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New Inheritance Funding Form</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                <li class="page-item"><a class="page-link bg-primary" href="{{url('inheritancefundingform/list')}}"> Data <i class="fas fa-table"></i></a></li>
                <li class="page-item">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('inheritancefundingform')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="What is the name of the person you received the inheritance from?" id="person_received_inheritance" name="person_received_inheritance">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="When did you receive your inheritance?u received the inheritance from?" id="receive_inheritance_date" name="receive_inheritance_date">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="What was the total amount of the inheritance?" id="total_amount_inheritance" name="total_amount_inheritance">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="How much do you need now?" id="amount_you_need_now" name="amount_you_need_now">
                      </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('inheritancefundingform/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
