            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Team Member Data</li>
                </ol>
              </div>
            </div>
            <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-header">
                  <h3 class="card-title">Team Member Data</h3>
                    ...
                    <div class="card-tools">
                      <ul class="pagination pagination-sm float-right">
                        ...
                        <li class="page-item">
                          <a class="page-link" target="_blank" href="{{url('teammember/export/pdf')}}">
                            <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                          </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" target="_blank" href="{{url('teammember/export/excel')}}">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Member Designation</th>
                            <th class="text-center">Member Image</th>
                        ...
                        @if(count($dataRow))
                            @foreach($dataRow as $row)  
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{url('teammember/edit/'.$row->id)}}" type="button" class="btn btn-default">
                                                Edit 
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{url('teammember/delete/'.$row->id)}}" type="button" class="btn btn-default">
                                                Delete 
