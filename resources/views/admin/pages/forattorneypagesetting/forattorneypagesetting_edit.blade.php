...
@section("title","Edit For Attorney Page Setting")
@section("content")
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>For Attorney Page Setting</h1>
      </div>
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Update For Attorney Page Setting</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify For Attorney Page Setting</h3>
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('forattorneypagesetting/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
            ...
            <div class="card-body">
                            ...
                            <div class="col-md-6">
                                @if(isset($dataRow->background_image))
                                    @if(!empty($dataRow->background_image))
                                        <img class="img-thumbnail" src="{{url('upload/forattorneypagesetting/'.$dataRow->background_image)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      <!-- text input -->
                      <div class="form-group">
                        <label for="page_products_services_title">Page Products Services Title</label>
                        <input type="text" 
                            
                        <?php 
                        if(isset($dataRow->page_products_services_title)){
                            ?>
                            value="{{$dataRow->page_products_services_title}}" 
                            <?php 
                        }
                        ?>
                        
                        class="form-control" placeholder="Enter Page Products Services Title" id="page_products_services_title" name="page_products_services_title">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      <!-- text input -->
                      <div class="form-group">
                        <label for="page_settlement_funding_title">Page Settlement Funding Title</label>
                        <input type="text" 
                            
                        <?php 
                        if(isset($dataRow->page_settlement_funding_title)){
                            ?>
                            value="{{$dataRow->page_settlement_funding_title}}" 
                            <?php 
                        }
                        ?>
                        
                        class="form-control" placeholder="Enter Page Settlement Funding Title" id="page_settlement_funding_title" name="page_settlement_funding_title">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" rows="3"  placeholder="Enter Form Detail" id="form_detail" name="form_detail"><?php 
                                if(isset($dataRow->form_detail)){
                                    
                                    echo $dataRow->form_detail;
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('forattorneypagesetting/edit/'.$dataRow->id)}}">
