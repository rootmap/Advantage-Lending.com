...
@section("title","Create New Types Of Funding Pre Settlement")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Create New Types Of Funding Pre Settlement</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New Types Of Funding Pre Settlement</h3>            
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('typesoffundingpresettlement')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Icon One Heading" id="icon_one_heading" name="icon_one_heading">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Icon Two Heading" id="icon_two_heading" name="icon_two_heading">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Icon Three Heading" id="icon_three_heading" name="icon_three_heading">
                      </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('typesoffundingpresettlement/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
