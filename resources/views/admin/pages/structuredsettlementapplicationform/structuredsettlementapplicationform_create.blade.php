                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter City Name" id="street_address" name="street_address">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="What was the total amount of the award?" id="total_amount_of_the_award" name="total_amount_of_the_award">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="How much do you receive in each payment?" id="how_much_receive_each_payment" name="how_much_receive_each_payment">
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="How much do you need now?" id="how_much_do_you_need_now" name="how_much_do_you_need_now">
                      </div>
                    </div>
                </div>
